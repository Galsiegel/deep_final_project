"""
Example script for using Massive RESTClient to fetch stock data.

This file contains example code for fetching aggregates (OHLCV bars) and other data.
To use this code, run it as a script: python -m Massive.RESTClient
"""
...
def main():
    """Main function - only executes when run as a script."""
    ...
    for a in client.list_aggs(
        ...
        timespan="minute",       # Time unit for each bar: "minute", "hour", "day", "week", "month"
